...
def run(window,length,height): #여기에서의 변수와 위의 변수는 다름
    ...
    real_space.gravity=(0,981) #중력 벡터 설정하기, 1사분면 꺼꾸로라고 생각하기
    for i in range(1000):
        real_ball=create_ball(real_space,random_postion()) #real_space에 공 만들기    
